...
// This code has been copied from Boost (1.35.0?).
// The patch referenced in http://boost.2283326.n4.nabble.com/smart-ptr-Problem-with-circular-reference-detection-td2582772.html has been applied.
...
{
    // JL: This static sometimes gets destroyed too early.
    //static map_type m;
    static map_type * pMap = new map_type;
    map_type & m = *pMap;
    return m;
}
...
static mutex_type & get_mutex()
{
    // JL: This static sometimes gets destroyed too early.
    //static mutex_type m;
    static mutex_type * pMutex = new mutex_type;
    mutex_type & m = *pMutex;
    return m;
}
